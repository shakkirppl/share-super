...
<div class="col-12 grid-margin createtable">
          ...
          @endif
                  ...
                  <form class="form-sample"  action="{{ route('country.store') }}" method="post" enctype="multipart/form-data"  >
                          {{csrf_field()}}
                    <div class="row">
                      ...
                      <div class="col-md-12">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" placeholder="New Country" name="name"  value="{{old('name')}}"  />
                          </div>
                        </div>
                      </div>
